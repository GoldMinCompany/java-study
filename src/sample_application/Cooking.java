...
public class Cooking {
	...
	public static void main(String[] args) {
			...
			case 2:
				...
				System.out.println("가스벨브를 연다.");
				System.out.println("불을 붙인다.");
				
			case 3:
				
				System.out.println("라면을 꺼낸다.");
				System.out.println("라면봉지를 뜯는다.");
				...
				System.out.println("건너기 스프를 흔든다.");
				System.out.println("건너기 스프를 넣는다.");
				System.out.println("비닐봉지들을 쓰레기통에 버린다.");
				System.out.println("면을 넣는다.");
				
			case 4:
				
				System.out.println("냉장고로 가고 계란을 꺼내 깨어서 냄비에 넣는다.");
				
			case 5:
				
				System.out.println("면을 들었다 놨다 해준다.");
				System.out.println("익을 때까지 반복한다.");
				System.out.println("불을 끈다.");
				System.out.println("가스벨브를 잠근다.");
				
			case 6:
				
				System.out.println("전공책을 깔아서 냄비를 올리고 젓가락으로 맛잇게 먹는다.");
